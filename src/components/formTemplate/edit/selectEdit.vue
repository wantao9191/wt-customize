  ...
  <div class="item-option">
    <el-form size="mini" label-width="100px">
      ...
      <el-form-item label="提示">
        <el-input v-model="value.configs.placeholder"></el-input>
      </el-form-item>
      <el-form-item label="选项">
        <el-radio-group v-model="value.configs.value" v-if="!value.configs.multiple">
          <el-radio v-for="(l,i) in value.configs.list" :label="l.value" :key="i">
            <div class="list-item">
              <div class="item-option">
                <span>label:</span>
        ...
        <el-checkbox-group v-model="value.configs.value" v-else>
          <el-checkbox v-for="(l,i) in value.configs.list" :label="l.value" :key="i">
            <div class="list-item">
              <div class="item-option">
                <span>label:</span>
                <el-input size="mini" v-model="l.label"></el-input>
      ...
      <el-form-item label="多选">
        <el-checkbox v-model="value.configs.multiple" @change="multipleSelect"></el-checkbox>
      </el-form-item>
      ...
      <el-form-item label="搜索">
        <el-checkbox v-model="value.configs.filterable"></el-checkbox>
      </el-form-item>
      <el-form-item label="清空">
        <el-checkbox v-model="value.configs.clearable"></el-checkbox>
      </el-form-item>
    </el-form>
  </div>
</template>
